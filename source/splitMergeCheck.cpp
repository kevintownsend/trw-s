...
int main(int argc, char* argv[]) {
    ...
    //TODO: find differences between mrf and mrf2
    cout << "mrf:" << endl;
    cout << "width:" << mrf.width << endl;
    cout << "height:" << mrf.height<< endl;
    cout << "data0:" << (int)mrf.data[0][0] << endl;
    cout << "mrf2:" << endl;
    cout << "width:" << mrf2.width << endl;
    cout << "height:" << mrf2.height<< endl;
    cout << "data0:" << (int)mrf2.data[0][0] << endl;

    for(int i = 0; i < mrf.width*mrf.height; i++){
        for(int j = 0; j < LABELS; j++){
            if(mrf.data[i][j] != mrf2.data[i][j]){
                cout << "bloody fuck" << endl;
                break;
            }
    ...
    for(int i = 0; i < mrf.width*mrf.height; i++){
        for(int j = 0; j < LABELS; j++){
            if(mrf.array[i].left[j] != mrf2.array[i].left[j]){
                cout << "bloody fuck" << endl;
                break;
            }
            if(mrf.array[i].right[j] != mrf2.array[i].right[j]){
                cout << "bloody fuck" << endl;
                break;
            }
            if(mrf.array[i].up[j] != mrf2.array[i].up[j]){
                cout << "bloody fuck" << endl;
                break;
            }
            if(mrf.array[i].down[j] != mrf2.array[i].down[j]){
                cout << "bloody fuck" << endl;
                break;
            }
